...
<div class="container well login_block" align="center">
	...
	<div class="row">
		<form ng-app="myapp" ng-controller="BrijController" name="myForm"  novalidate>
			...
			<tr>
			<p>
			<td><input type="submit" onClick="check_details()" id="submit_btn" class="btn btn-primary" ng-disabled="myForm.s_user.$invalid ||  myForm.s_email.$invalid ||  myForm.s_password.$invalid ||  myForm.s_cpassword.$invalid ||   myForm.s_mobile.$invalid"></td>
