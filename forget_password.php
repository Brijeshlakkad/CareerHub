...
<form  name="myForm" novalidate  method="post">
		<table class="myTable">
			<div class="form-group">
				...
				<tr>
					<td><img src="images/loading_spinner.gif" id="spinner1" style="height:30px;width: 30px;" alt="Loading" /><input class="btn btn-primary" id="send" ng-disabled="myForm.forget_email.$invalid" type="submit" value="submit" /></td>
					<td id="status1"></td>
				</tr>
			</div>
		</table>
		...
		<table class="myTable">
			<div class="form-group">
				<tr>
					...
					<td><img src="images/loading_spinner.gif" id="spinner2" style="height:30px;width: 30px;" alt="Loading" /><button class="btn btn-link" id="resend" >Resend</button></td>
				</tr>
				<tr>
					<td></td>
...
<div id="new_password">
	<form ng-controller="BrijController" name="myForm2" method="post">
		<table class="myTable">
				...
				<tr>
					<td></td>
					<td><img src="images/loading_spinner.gif" id="spinner3" style="height:30px;width: 30px;" alt="Loading" /><input class="btn btn-primary" id="change_pass" ng-disabled=" myForm2.s_password.$invalid ||  myForm2.s_cpassword.$invalid" type="submit" value="submit" /></td>
					<td id="status3"></td>
					<td></td>
				</tr>
			</div>
